...
us-west-2       qa      vpc-foo    A.B.C.D/20  private         us-west-2a    a            subnet-bar                 E.F.G.H/22
us-west-2       qa      vpc-foo    A.B.C.D/20  private         us-west-2b    b            subnet-[id]            I.J.K.L/22
us-west-2       qa      vpc-foo    A.B.C.D/20  private         us-west-2c    c            subnet-[id]            M.N.O.P/22
us-west-2       qa      vpc-foo    A.B.C.D/20  public          us-west-2a    a            subnet-[id]  A.B.C.D/24
us-west-2       qa      vpc-foo    A.B.C.D/20  public          us-west-2b    b            subnet-[id]  Q.R.S.T/24
us-west-2       qa      vpc-foo    A.B.C.D/20  public          us-west-2c    c            subnet-[id]  U.V.W.X/24
'
  ...
  def self.office_cidrs()
    [
        ...
        "80.169.157.168/29",  # Bazaarvoice London office
        "108.60.148.98/32",   # Bazaarvoice NY office
